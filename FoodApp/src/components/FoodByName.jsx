...
import { getFoodsByFoodName } from '../FoodService';

function FoodByName({ foodlist, addToCart}) {
...
useEffect(() => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
            ...
            getFoodsByFoodName(name).then((res) => {
                setFoods(res.data)
                console.log(foods)
            })
            console.log(foods)
  ...
  return (
    <div>  
        ...
        <h1>Serch By <span className='font-bold'>Food Name</span></h1>
        <form onSubmit={handleSubmit} className='mt-4 w-1/6'>
            <Input type="text" label="Enter Food Name" name="name"/><br />
